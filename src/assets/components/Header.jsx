      ...
      <div className='bg-white dark:bg-[#171718] dark:border-b-2  border-gray-500'>
        <header className='contain flex items-center justify-between py-4'>
          <div className='logo  flex  items-center gap-4'>
            ...
            <Link
              to='/'
              className='text-4xl text-black dark:text-blue-300 font-bold '
            >
              {t('brave')}
            </Link>
          </div>
          <nav className='flex gap-8'>
            <NavLink
              to='/'
              className='navlink dark:text-white dark:hover:bg-gray-600 dark:border-2'
            >
              {t('home')}
            </NavLink>
            <NavLink
          ...
          <div className='dark flex items-center gap-10'>
            <div className='input '>
            ...
            <select onChange={handleLang} className='px-6 h-12 rounded-lg'>
              <option value='en'>English</option>
              <option value='uz'>Uzbek</option>
            </select>
            <button className='py-2 px-4 rounded-2xl bg-blue-500 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-slate-200  font-bold text-white hover:bg-blue-600'>
              {t('button')}
            </button>
          </div>
        </header>
